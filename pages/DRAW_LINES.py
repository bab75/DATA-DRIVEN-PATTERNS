...
with st.expander("📚 Help: How the Analysis Works"):
    ...
    - **How**: For uploaded files, ensure columns: date, open, high, low, close, volume. For real-time, fetch data via Yahoo Finance with a single valid symbol (e.g., AAPL).
    ...
    **Troubleshooting Tips**:
    ...
    - **Upload Errors**: Verify the file has columns: date, open, high, low, close, volume. Use the sample file provided. Upload benchmark data (e.g., all_profit_loss_data.xlsx) as 'Benchmark Data'.
